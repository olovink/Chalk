...
class FormatterFactory{
    public static function createDefault(bool $showRemainingContext = false): CompositeFormatter{
        return (new FormatterBuilder())
            ...
            ->addLiteral(' ')
            ->addLevelPart('[', ']', null, [
				LogLevel::EMERGENCY->value => new Style(new CombinedColor(ConsoleColor::BG_RED, ConsoleColor::WHITE, ConsoleColor::BOLD)),
				LogLevel::ALERT->value     => new Style(new CombinedColor(ConsoleColor::BG_RED, ConsoleColor::WHITE)),
				LogLevel::CRITICAL->value  => new Style(new CombinedColor(ConsoleColor::RED, ConsoleColor::BOLD)),
